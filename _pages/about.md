...
<div style="font-size: 0.95em; padding: 0.1em 0.50em; padding-top:6px; border-radius: 0.5em; border: 2px solid #ff3000; background: #f9f3decf" markdown="1">
![Announcement](/assets/images/hiclipart_announcement.png){: width="30" } If you're a current Master's student in the CS or a related department at UH and are interested in working with me on a research project, thesis, or capstone related to <b>Automated Software Productivity</b> (code synthesis and translation) and <b>Code Reliability and Quality</b> (bug detection and security assurance), feel free to reach out. Please note that we're not hiring for RA or TA positions at the moment, but I'd be happy to hear from you if you're looking for an advisor or a voluntary research experience and are interested in publishing in top-ranked conferences in the field.
</div>
<br/>
...
- Fall 2025, Fall 2026: [COSC 4315 - Programming Languages and Paradigms](https://uh.simplesyllabus.com/en-US/doc/4kg2x75pu/Fall-2025-COSC-4315-26604-?mode=view)
- Spring 2026: [COSC 6386 - Program Analysis and Testing](#)
